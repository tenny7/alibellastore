...
export default async function ReturnPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <h1 className="font-display tracking-[-0.03em] text-2xl font-bold text-surface-fg mb-6">Return & Refund Policy</h1>

      <div className="prose prose-gray max-w-none space-y-6 text-surface-muted text-sm leading-relaxed">
        <p>Last updated: {new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}</p>

        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">1. Return Window</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">2. Non-Returnable Items</h2>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">3. How to Request a Return</h2>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">4. Refund Process</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">5. Damaged or Defective Items</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">6. Exchanges</h2>
          <p>

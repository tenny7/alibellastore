...
export default async function TermsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <h1 className="font-display tracking-[-0.03em] text-2xl font-bold text-surface-fg mb-6">Terms of Service</h1>

      <div className="prose prose-gray max-w-none space-y-6 text-surface-muted text-sm leading-relaxed">
        <p>Last updated: {new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}</p>

        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">1. Acceptance of Terms</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">2. Products and Pricing</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">3. Orders and Payment</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">4. Shipping and Delivery</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">5. User Accounts</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">6. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">7. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">8. Changes to Terms</h2>
          <p>
        ...
        <section>
          <h2 className="font-display tracking-[-0.02em] text-lg font-bold text-surface-fg mt-8 mb-3">9. Contact</h2>
          <p>

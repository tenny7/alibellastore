  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1.5 max-w-[620px] text-sm leading-relaxed text-page-fg/50">
      ...
      {unavailable ? (
        ...
        <div className="space-y-10">
          <section>
            <h2 className="mb-1.5 font-display text-lg font-bold tracking-[-0.02em] text-page-fg">
              Testimonials
            </h2>
            <p className="mb-4 text-[13px] text-page-fg/45">
